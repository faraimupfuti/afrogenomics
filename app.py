...
LANG = {
    "EN": {
        ...
        "hero_cta": "Book a free consultation →", "hero_ghost": "View services",
        "stats": [
            ("10+", "Pipeline and ML projects delivered"),
            ("Pan-African", "Focus on African research institutions"),
            ("2–4 wks", "Typical turnaround on a pipeline project"),
            ("Local", "Analysis delivered locally, not outsourced overseas"),
        ],
        ...
        "steps": [
            ...
            ("02", "We agree a fixed deliverable before work begins",
        ...
        "clients": [
            ...
            ("🌍", "NGOs & Global Health Orgs", "PEPFAR-funded programmes, Wellcome Trust projects, and Gates Foundation-backed initiatives needing local African bioinformatics capacity."),
            ("🧪", "Diagnostics Labs", "Private and public labs scaling up to offer genomic testing services who need pipeline infrastructure without a full in-house team."),
            ("🌱", "Agricultural Research", "Crop genomics and disease-resistance profiling for commercial farms and agricultural research bodies across Zimbabwe and the SADC region."),
            ("💊", "Pharma & Biotech", "Companies needing African-population genomic analysis, NTD drug target work, or bioinformatics support for clinical trial datasets."),
        ],
        ...
        "services": [
            ...
            {"icon":"💊","title":"Drug Target & Repurposing Analysis","who":"For NTD, HIV, and TB research programs",
             "desc":"We computationally identify which existing approved drugs have potential against your target, using AI-predicted protein structures and molecular screening. Faster and cheaper than starting drug discovery from scratch.",
             "price":"Scoped per project","badge":None},
        ...
        "pricing": [
            ...
            {"service":"Training & Capacity Building","price":"From $300 / participant","timeline":"1–3 days",
             "includes":["Customised curriculum for your team","Hands-on practical sessions — not just slides","All training materials and code notebooks provided","Post-workshop support channel for 2 weeks","Certificate of completion"]},
        ...
        "about_p1": "Afrogenomics was founded to close a specific gap: African research institutions generate growing volumes of genomic and sequencing data, but the bioinformatics capacity to analyse it locally remains scarce — meaning analysis is routinely outsourced overseas, adding cost, delay, and distance from the people the research is meant to serve.",
        "about_p2": "We work with universities, research institutes, NGOs, and diagnostics labs across Zimbabwe and the wider region to build pipelines, run analyses, and train local teams — so that capacity stays where the data and the need both are.",
        "about_p3": "Our work spans HIV and TB genomic surveillance, agricultural genomics, drug-repurposing target discovery for neglected tropical diseases, and pipeline infrastructure for labs scaling up their omics capabilities.",
        "faq_label": "Questions", "faq_title": "Frequently asked questions",
        "faqs": [
            ("Do I need to send you my raw sequencing files?",
             "Not necessarily. We can work with raw reads (FASTQ), aligned files (BAM), or variant files (VCF). If you have already processed your data partway, we pick up from wherever you are. We will tell you exactly what format we need during scoping."),
            ("Is my data secure?",
             "Yes. All data is transferred over encrypted channels and stored securely on cloud infrastructure with access restricted to this engagement only. We do not share, publish, or retain your data after project completion."),
            ...
            ("How long does a typical project take?",
             "Most pipeline and variant calling projects complete within 2 to 4 weeks from receiving your data. More complex ML or drug-repurposing projects typically take 4 to 8 weeks. We agree a specific timeline during scoping and stick to it."),
        ...
        "contact_sub": "Tell us about your data and research question — we will respond with a scoped proposal within 24 hours.",
    ...
    "FR": {
        ...
        "hero_sub": "Nous construisons les pipelines d'analyse, l'infrastructure et l'interprétation dont les institutions de recherche africaines ont besoin — sans les coûts ni les délais liés à l'externalisation outre-mer.",
        "hero_cta": "Consultation gratuite →", "hero_ghost": "Voir les services",
        "stats": [
            ("10+", "Projets pipeline et ML livrés"),
            ("Pan-Africain", "Axé sur les institutions de recherche africaines"),
            ("2–4 sem.", "Délai typique pour un projet pipeline"),
            ("Local", "Analyse locale, pas d'externalisation en Europe"),
        ],
        ...
        "steps": [
            ("01", "Dites-nous ce que vous avez et ce dont vous avez besoin",
             "Partagez vos données de séquençage ou une description, votre question de recherche et votre délai. Aucun jargon technique requis."),
            ("02", "Nous convenons d'un livrable fixe avant le début des travaux",
             "Vous recevez un cahier des charges court: exactement ce que nous analyserons, ce que vous recevrez, le calendrier et le coût. Aucune surprise."),
        ...
        "clients": [
            ...
            ("🌱", "Recherche Agricole", "Génomique des cultures et profilage de résistance aux maladies pour les exploitations et organismes de recherche agricole."),
            ("💊", "Pharma & Biotech", "Entreprises ayant besoin d'analyses génomiques de populations africaines ou de support bioinformatique pour essais cliniques."),
        ],
        ...
        "services": [
            {"icon":"🔬","title":"Pipelines d'Analyse Génomique","who":"Pour les laboratoires avec des données non analysées",
             "desc":"Vous nous envoyez vos fichiers bruts. Nous construisons un flux de travail automatisé et reproductible et retournons des résultats propres et annotés prêts pour un article ou un rapport.",
            ...
            {"icon":"🧬","title":"Appel de Variants & Rapport de Résistance","who":"Pour les groupes de recherche sur le VIH, la TB et les maladies infectieuses",
             "desc":"Nous prenons votre sortie de séquençage brute et retournons un rapport identifiant chaque mutation et signalant celles ayant des implications de résistance aux médicaments connues.",
            ...
            {"icon":"🤖","title":"Prédiction Génomique par IA","who":"Pour les chercheurs qui ont besoin de plus qu'une analyse standard",
             "desc":"Lorsque votre question va au-delà de l'identification des mutations — prédiction de réponse au traitement, identification de médicaments potentiels — nous construisons un modèle IA personnalisé.",
            ...
            {"icon":"🎓","title":"Formation & Renforcement des Capacités","who":"Pour les universités, instituts et équipes de laboratoire",
             "desc":"Votre équipe collecte les données — nous leur apprenons à les analyser. Ateliers pratiques dispensés sur place à Harare ou à distance.",
            ...
            {"icon":"🔄","title":"Support de Recherche Continu","who":"Pour les laboratoires actifs ayant besoin d'un bioinformaticien disponible",
             "desc":"Un arrangement mensuel dédié pour les laboratoires menant des recherches continues. Nous gérons vos besoins d'analyse courants et le support pour les rapports de subventions.",
             "price":"Nous contacter","badge":"by_inquiry"},
        ],
        "price_label": "Tarification transparente", "price_title": "Ce qu'inclut chaque service",
        "price_sub": "Portée fixe signifie aucune facture surprise. Voici exactement ce que vous obtenez.",
        "pricing": [
            {"service":"Pipelines d'Analyse Génomique","price":"À partir de 2 000 $","timeline":"2–4 semaines",
             "includes":["Pipeline Nextflow / nf-core reproductible","Rapport QC complet","Fichiers de sortie alignés et annotés","Résumé en langage clair","1 cycle de révision inclus"]},
            ...
            {"service":"Prédiction Génomique par IA","price":"Devis","timeline":"4–8 semaines",
             "includes":["Conception du modèle","Formation, validation et rapport de performance","Sortie interprétable","Documentation complète","Code et modèle livrés"]},
        ...
        "about_p1": "Afrogenomics a été fondée pour combler un écart spécifique : les institutions de recherche africaines génèrent des volumes croissants de données génomiques et de séquençage, mais la capacité bioinformatique pour les analyser localement reste rare — ce qui signifie que l'analyse est régulièrement externalisée à l'étranger, ajoutant des coûts, des délais et de la distance par rapport aux personnes que la recherche est censée servir.",
        "about_p2": "Nous travaillons avec des universités, des instituts de recherche, des ONG et des laboratoires de diagnostic à travers le Zimbabwe et la région élargie pour construire des pipelines, exécuter des analyses et former des équipes locales — afin que la capacité reste là où se trouvent les données et le besoin.",
        "about_p3": "Notre travail couvre la surveillance génomique du VIH et de la TB, la génomique agricole, la découverte de cibles médicamenteuses pour les maladies tropicales négligées, et l'infrastructure pipeline pour les laboratoires qui développent leurs capacités omiques.",
        ...
        "faqs": [
            ...
            ("Mes données sont-elles sécurisées ?",
             "Oui. Toutes les données sont transférées via des canaux chiffrés et stockées en toute sécurité. Nous ne partageons pas vos données après la fin du projet."),
            ...
            ("Pouvez-vous travailler avec des données de n'importe quelle plateforme ?",
            ...
            ("Et si je ne suis pas sûr du service dont j'ai besoin ?",
             "Décrivez simplement votre question de recherche et les données que vous avez, et nous recommanderons la bonne approche."),
        ],
        ...
        "form_fallback": "Le message n'a pas pu être envoyé. Veuillez envoyer un e-mail à faraimupfuti@gmail.com.",
        ...
        "direct_sub": "La plupart des clients trouvent plus facile d'expliquer leur question en un appel ou message rapide.",
    ...
    "PT": {
        ...
        "hero_sub": "Construímos os pipelines de análise, infraestrutura e interpretação que instituições de pesquisa africanas precisam — sem o custo ou atraso de terceirizar a análise para o exterior.",
        "hero_cta": "Agendar consulta gratuita →", "hero_ghost": "Ver serviços",
        "stats": [
            ("10+", "Projetos de pipeline e ML entregues"),
            ("Pan-Africano", "Foco em instituições de pesquisa africanas"),
            ("2–4 sem.", "Prazo típico para um projeto de pipeline"),
            ("Local", "Análise local, sem terceirização para Europa"),
        ],
        ...
        "steps": [
            ...
            ("02", "Acordamos um produto final fixo antes de começar qualquer trabalho",
             "Você recebe um escopo curto por escrito: exatamente o que analisaremos, o que você receberá, o cronograma e o custo. Sem surpresas."),
            ("03", "Receba seus resultados, explicados claramente",
             "Entregamos seu relatório com um resumo em linguagem simples. Perguntas de acompanhamento incluídas sem custo adicional."),
        ],
        ...
        "services": [
            {"icon":"🔬","title":"Pipelines de Análise Genómica","who":"Para laboratórios com dados de sequenciamento não analisados",
             "desc":"Você nos envia seus arquivos brutos. Construímos um fluxo de trabalho automatizado e reproductível e retornamos resultados limpos e anotados prontos para uso em um artigo ou relatório.",
            ...
            {"icon":"🧬","title":"Chamada de Variantes & Relatório de Resistência","who":"Para grupos de pesquisa em HIV, TB e doenças infecciosas",
             "desc":"Pegamos sua saída de sequenciamento bruta e retornamos um relatório identificando cada mutação e sinalizando aquelas com implicações conhecidas de resistência a medicamentos.",
            ...
            {"icon":"🤖","title":"Predição Genómica por IA","who":"Para pesquisadores que precisam de mais do que uma análise padrão",
             "desc":"Quando sua pergunta vai além de identificar mutações — prever resposta ao tratamento, identificar quais medicamentos podem funcionar contra um novo patógeno — construímos um modelo de IA personalizado.",
            ...
            {"icon":"🔄","title":"Suporte de Pesquisa Contínuo","who":"Para laboratórios ativos que precisam de um bioinformata disponível",
             "desc":"Um contrato mensal dedicado para laboratórios que conduzem pesquisas contínuas. Gerenciamos suas necessidades de análise e suporte para relatórios de bolsas.",
             "price":"Consultar","badge":"by_inquiry"},
        ],
        "price_label": "Preços transparentes", "price_title": "O que cada serviço inclui",
        "price_sub": "Escopo fixo significa sem faturas surpresa. Aqui está exatamente o que você obtém.",
        "pricing": [
            {"service":"Pipelines de Análise Genómica","price":"A partir de $2.000","timeline":"2–4 semanas",
             "includes":["Pipeline Nextflow / nf-core reproduzível","Relatório QC completo","Arquivos de saída alinhados e anotados","Resumo em linguagem simples","1 rodada de revisão incluída"]},
        ...
        "about_p1": "A Afrogenomics foi fundada para fechar uma lacuna específica: as instituições de pesquisa africanas geram volumes crescentes de dados genómicos e de sequenciamento, mas a capacidade bioinformática para analisá-los localmente permanece escassa — o que significa que a análise é rotineiramente terceirizada para o exterior, adicionando custo, atraso e distância das pessoas que a pesquisa pretende servir.",
        "about_p2": "Trabalhamos com universidades, institutos de pesquisa, ONGs e laboratórios de diagnóstico em todo o Zimbabwe e na região mais ampla para construir pipelines, executar análises e treinar equipes locais — para que a capacidade permaneça onde estão os dados e a necessidade.",
        "about_p3": "Nosso trabalho abrange vigilância genómica de HIV e TB, genómica agrícola, descoberta de alvos para doenças tropicais negligenciadas e infraestrutura de pipeline para laboratórios que expandem suas capacidades ómicas.",
        ...
        "faqs": [
            ...
            ("Meus dados são seguros?",
             "Sim. Todos os dados são transferidos por canais criptografados e armazenados com segurança. Não compartilhamos ou retemos seus dados após a conclusão do projeto."),
            ...
            ("Quanto tempo dura um projeto típico?",
             "A maioria dos projetos de pipeline conclui em 2 a 4 semanas. Projetos mais complexos de ML normalmente levam 4 a 8 semanas."),
            ...
            ("E se eu não tiver certeza de qual serviço preciso?",
             "Descreva sua pergunta de pesquisa e os dados que você tem, e recomendaremos a abordagem certa."),
        ],
...
# ─── CSS ─────────────────────────────────────────────────────────────────────
st.markdown("""<link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&family=Playfair+Display:wght@600;700&display=swap" rel="stylesheet">
<style>
...
.ag-logo{font-family:'Playfair Display',serif;font-size:1.4rem;font-weight:700;color:#F0EDE4!important;}
.ag-logo span{color:#4CAF82;}
.ag-nav-links{display:flex;gap:2rem;align-items:center;}
.ag-nav-links a{color:#9A9688!important;text-decoration:none;font-size:0.875rem;font-weight:500;}
.ag-nav-links a:hover{color:#4CAF82!important;}
.ag-eyebrow{display:inline-block;font-size:0.72rem;font-weight:600;letter-spacing:0.2em;text-transform:uppercase;color:#4CAF82!important;border:1px solid rgba(76,175,130,0.3);border-radius:100px;padding:0.3rem 0.9rem;margin-bottom:1.5rem;}
.ag-hero{padding:5rem 0 4rem;position:relative;}
...
.ag-hero-title{font-family:'Playfair Display',serif!important;font-size:3rem!important;font-weight:700!important;color:#F0EDE4!important;line-height:1.18!important;max-width:780px;margin-bottom:1.2rem;}
.ag-hero-sub{font-size:1.05rem;color:#9A9688!important;max-width:580px;line-height:1.75;margin-bottom:2rem;}
.ag-btn-primary{display:inline-block;background:linear-gradient(135deg,#4CAF82 0%,#2E8B5A 100%);color:#071612!important;font-weight:700;font-size:0.9rem;padding:0.8rem 1.8rem;border-radius:6px;text-decoration:none;box-shadow:0 4px 24px rgba(76,175,130,0.25);}
.ag-btn-ghost{display:inline-block;background:transparent;color:#C8C4B6!important;font-weight:600;font-size:0.9rem;padding:0.8rem 1.8rem;border-radius:6px;border:1px solid #2A4A3F;text-decoration:none;margin-left:0.75rem;}
.ag-stats{display:flex;border:1px solid #1A3830;border-radius:10px;background:#0D2218;overflow:hidden;margin:0;}
...
.ag-step{background:#0D2218;border:1px solid #1A3830;border-radius:10px;padding:2rem;height:100%;}
...
.ag-client-card{background:#0D2218;border:1px solid #1A3830;border-radius:10px;padding:1.6rem;margin-bottom:1rem;}
.ag-client-card:hover{border-color:#2E6B4F;}
...
.ag-service-card{background:#0D2218;border:1px solid #1A3830;border-radius:10px;padding:1.75rem;height:100%;margin-bottom:1rem;position:relative;overflow:hidden;}
...
.ag-service-card:hover{border-color:#2E6B4F;}
...
.ag-price-card{background:#0D2218;border:1px solid #1A3830;border-radius:10px;padding:1.75rem;margin-bottom:1rem;}
...
.ag-price-includes li::before{content:'✓';color:#4CAF82;font-weight:700;flex-shrink:0;}
...
.ag-about-card{background:#0D2218;border:1px solid #1A3830;border-radius:10px;padding:2rem;}
.ag-about-card p{font-size:0.95rem;color:#9A9688!important;line-height:1.85;margin-bottom:1rem;}
.ag-about-card p:last-child{margin-bottom:0;}
...
.ag-contact-card h3{font-size:1.1rem!important;color:#F0EDE4!important;margin-bottom:0.5rem;}
...
label[data-testid="stWidgetLabel"] p{color:#9A9688!important;font-size:0.82rem!important;font-weight:500!important;}
.stFormSubmitButton>button{background:linear-gradient(135deg,#4CAF82,#2E8B5A)!important;color:#071612!important;font-weight:700!important;border:none!important;border-radius:6px!important;padding:0.75rem 2rem!important;width:100%!important;}
...
with nav_r:
    ...
    with nr1:
        st.markdown(f"""<div class="ag-nav-links">
...
st.markdown('<hr class="ag-divider" style="margin:0;">', unsafe_allow_html=True)
...
# ─── STATS ────────────────────────────────────────────────────────────────────
stats_html = "".join([
    f'<div class="ag-stat"><span class="ag-stat-num">{num}</span><span class="ag-stat-label">{label}</span></div>'
    for num, label in L["stats"]
])
st.markdown(f'<div class="ag-stats">{stats_html}</div>', unsafe_allow_html=True)
...
# ─── WHO WE SERVE ─────────────────────────────────────────────────────────────
st.markdown(f"""<div id="clients" style="padding:1rem 0 1rem;">
...
for i, (icon, title, desc) in enumerate(L["clients"]):
    with cc[i % 3]:
        st.markdown(f"""<div class="ag-client-card">
...
# ─── SERVICES ─────────────────────────────────────────────────────────────────
st.markdown(f"""<div id="services" style="padding:1rem 0 1rem;">
...
for i, svc in enumerate(L["services"]):
    with sc[i % 3]:
        ...
        if svc["badge"] == "coming_soon":
            badge = '<span class="ag-card-badge ag-badge-soon">Coming Soon</span>'
        elif svc["badge"] == "by_inquiry":
            badge = '<span class="ag-card-badge ag-badge-inquiry">By Inquiry</span>'
        st.markdown(f"""<div class="ag-service-card">
...
# ─── PRICING ──────────────────────────────────────────────────────────────────
st.markdown(f"""<div id="pricing" style="padding:1rem 0 1rem;">
...
for i, p in enumerate(L["pricing"]):
    with [pc1, pc2][i % 2]:
        items = "".join([f"<li>{item}</li>" for item in p["includes"]])
        st.markdown(f"""<div class="ag-price-card">
            ...
            <ul class="ag-price-includes">{items}</ul>
        </div>""", unsafe_allow_html=True)
st.markdown('<hr class="ag-divider">', unsafe_allow_html=True)

# ─── TOOLS ────────────────────────────────────────────────────────────────────
st.markdown(f"""<div id="tools" style="padding:1rem 0 1rem;">
...
# ─── ABOUT ────────────────────────────────────────────────────────────────────
st.markdown(f"""<div id="about" style="padding:1rem 0 1rem;">
    <span class="ag-section-label">{L['about_label']}</span>
    <h2 class="ag-section-title">{L['about_title']}</h2>
</div>""", unsafe_allow_html=True)
st.markdown(f"""<div class="ag-about-card">
    <p>{L['about_p1']}</p>
    <p>{L['about_p2']}</p>
    <p>{L['about_p3']}</p>
</div>""", unsafe_allow_html=True)
...
# ─── FAQ ──────────────────────────────────────────────────────────────────────
st.markdown(f"""<div id="faq" style="padding:1rem 0 1rem;">
...
# ─── CONTACT ──────────────────────────────────────────────────────────────────
st.markdown(f"""<div id="contact" style="padding:1rem 0 1rem;">
    ...
    with st.form("contact_form"):
        ...
        if submitted:
            if name and email and message:
                ...
                st.success(L["form_success"]) if sent else st.warning(L["form_fallback"])
            else:
                st.error(L["form_error"])
with ct2:
    st.markdown(f"""<div class="ag-contact-card">
        ...
        <a class="ag-wa-btn" href="https://wa.me/263775643044?text=Hi%20Farai%2C%20I%20found%20Afrogenomics%20and%20would%20like%20to%20discuss%20a%20project." target="_blank">{L['wa_btn']}</a>
    </div>""", unsafe_allow_html=True)

# ─── FOOTER ───────────────────────────────────────────────────────────────────
st.markdown("""<div class="ag-footer">
